...
impl ImportNodeKind {
  pub fn compute(id: &str, in_root: bool) -> ImportNodeKind {
...
pub struct ImportNodeMap {
  #[serde(flatten)]
  pub map: HashMap<Arc<String>, ImportNode>,
}
...
impl ImportNodeMap {
  ...
  pub fn create_node(&mut self, id: &str) {
  ...
  pub fn insert_node_depend(&mut self, id: &str, module: ImportNode) -> &mut ImportNode {
    unsafe {
